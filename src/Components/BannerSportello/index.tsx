...
const BannerSportello: React.FC = () => {
    return (
        <>
            <div className="w-full h-[300px] bg-[#90b791] flex flex-col gap-5 items-center justify-center text-center shadow-lg px-6">
                <h2 style={{ fontSize: "clamp(28px, 4vw, 48px)", fontWeight: 700, color: "#fbfdf4", margin: 0 }}>
                    Centro di supporto psicologico
                </h2>
                <p style={{ fontSize: "clamp(16px, 2vw, 20px)", color: "#fbfdf4", maxWidth: 900, margin: "0 auto", lineHeight: 1.8 }}>
